      ...
      <div class="drawer_wrap">
        <Form label-position="left" :label-width="85">
          <FormItem label="是否显示网格" :label-width="100">
            <i-switch v-model:value="showGrid" @on-change="showorhidenGrid" />
          </FormItem>
          <div v-show="showGrid">
            <FormItem label="网格类型">
              <RadioGroup v-model:value="grid.type" @on-change="changeGridType">
                <Radio
            ...
            <FormItem label="网格颜色">
              <ColorPicker
                v-model:value="grid.args.color"
                @on-change="changeGrid"
              />
            </FormItem>
            <FormItem label="网格线宽度">
              <Slider
                v-model:value="grid.args.thickness"
                :min="0"
                :max="20"
                @on-change="changeGrid"
              ></Slider>
    ...
    <div v-if="drawerType === 'node'">
      ...
      <div class="drawer_wrap">
        <Form label-position="left" :label-width="80">
          ...
          <FormItem label="节点背景">
            <ColorPicker
              v-model:value="drawerNode.fill"
              @on-change="changeFill"
            />
          </FormItem>
          <FormItem label="字体大小">
            <Slider
              v-model:value="drawerNode.fontSize"
              :min="10"
              :max="20"
          ...
          <FormItem label="字体颜色">
            <ColorPicker
              v-model:value="drawerNode.fontFill"
              @on-change="changeFontFill"
            />
          </FormItem>
          <FormItem label="边框宽度">
            <Slider
              v-model:value="drawerNode.strokeWidth"
              :min="0"
              :max="10"
          ...
          <FormItem label="边框颜色">
            <ColorPicker
              v-model:value="drawerNode.stroke"
    ...
    <div v-if="drawerType === 'edge'">
      ...
      <div class="drawer_wrap">
        <Form label-position="left" :label-width="80">
          ...
          <FormItem label="线条宽度">
            <Slider
              v-model:value="drawerEdge.edgeWidth"
              :min="1"
              :max="10"
          ...
          <FormItem label="线条颜色">
            <ColorPicker
              v-model:value="drawerEdge.edgeColor"
